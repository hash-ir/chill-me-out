...
public class HelloAction extends AnAction {
    ...
    private static final String FILE_PATH = "D:\\hackaTUM\\chill-me-out\\intellibuddy\\src\\stress.txt";
    ...
    void executePythonScript() {
        ...
        try {
            ...
            p = Runtime.getRuntime().exec("python D:\\hackaTUM\\chill-me-out\\intellibuddy\\src\\model.py");
    ...
    private void showChillNotification() {
        showMyMessage("Hello Hashir , you are cool !  Keep Chilling");
    }
